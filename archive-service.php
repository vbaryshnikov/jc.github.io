...
?>
    ...
    <section class="inner services tabs">
        <div class="wrapper">
            <h2 class="services__title secondary-title"><span><?php echo $wayup_options['servicearchivetitle1']; ?></span><br><?php echo $wayup_options['servicearchivetitle2'];  ?></h2>
            <div class="tabs__wrap">

                <p class="tabs__descr"><?php echo $wayup_options['servicearchivedesc'];  ?></p>
                <!-- Cases titles -->
            ...
            foreach ($services_types as $category){
                if ($j == 0) {$current = 'active';}else{
                    $current = '';
                }
                ?>
            <!-- Cases content one-->
                <div class="tabs__content <?php esc_attr($current); ?>">
