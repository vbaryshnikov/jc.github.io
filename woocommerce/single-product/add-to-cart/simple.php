...
if ( $product->is_in_stock() ) : ?>
    ...
    <div class="product__btns">
        <button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="product__btn btn"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
