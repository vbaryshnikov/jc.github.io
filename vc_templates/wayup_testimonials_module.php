				...
				<div class="clients__slide">
					<div class="clients__box">
						<div class="clients__photo">
							...
							<a href="<?php echo get_metadata('post', get_the_ID(),'wayup_social_link', true); ?>" class="clients__link">
						...
						<div class="add-time">
							...
							<p class="add-time__date"><?php echo get_metadata('post', get_the_ID(), 'wayup_testi_date', true); ?></p>
						</div>
					</div>
				</div>
			<?php endwhile;
